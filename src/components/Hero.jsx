      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
        ...
        >
          <div>
            ...
            <p className="text-xl text-gray-600 font-medium body-text">AI & Frontend Developer</p>
          </div>
          ...
          <div className="space-y-2">
            ...
            <p className="text-lg text-gray-600 leading-relaxed body-text">
              Passionate about creating AI-powered applications and immersive 3D web experiences. 
              Combining expertise in machine learning, React, Three.js, and modern web technologies 
